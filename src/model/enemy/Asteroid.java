...
public class Asteroid extends Enemy {
    ...
    public void update(Iterator i){
        if(isAlive()) {
            ...
            setOldY(getY());
            animateDeath();
            gc.getEnemies().add(new Enemy(EnemyType.ASTEROID, new EnemyMovementPattern("SIN"), getX(), getY()));
            gc.getEnemies().add(new Enemy(EnemyType.ASTEROID, new EnemyMovementPattern("SIN_REVERSED"), getX(), getY()));
        }
