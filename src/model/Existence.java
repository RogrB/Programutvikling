...
public abstract class Existence implements java.io.Serializable {
    ...
    /**
     * Test to see if an {@code Existence} collides with another {@code Existence}.
     * @param target The target {@code Existence} for {@code this} to be measured against.
     * @return {@code true} or {@code false}.
     */
    public boolean collidesWith(Existence target){
