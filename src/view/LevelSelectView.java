...
public class LevelSelectView extends ViewUtil{
    ...
    public Parent initScene(){
        ...
        Text levelName = new Text("Level 1");
        levelName.setX(525);
        levelName.setY(275);
        ...
        ImageView level1 = new ImageView("assets/image/placeholderBorder.png");
        level1.setFitHeight(160);
        level1.setFitWidth(200);
        ImageView level2 = new ImageView("assets/image/placeholderBorder.png");
        level2.setFitHeight(160);
        level2.setFitWidth(200);
        ImageView level3 = new ImageView("assets/image/placeholderBorder.png");
        level3.setFitHeight(160);
        level3.setFitWidth(200);
        ImageView level4 = new ImageView("assets/image/placeholderBorder.png");
        level4.setFitHeight(160);
        level4.setFitWidth(200);
        ImageView level5 = new ImageView("assets/image/placeholderBorder.png");
        level5.setFitHeight(160);
        level5.setFitWidth(200);
        ImageView level6 = new ImageView("assets/image/placeholderBorder.png");
        level6.setFitHeight(160);
        level6.setFitWidth(200);
        ImageView level7 = new ImageView("assets/image/placeholderBorder.png");
        level7.setFitHeight(160);
        level7.setFitWidth(200);
        ImageView level8 = new ImageView("assets/image/placeholderBorder.png");
