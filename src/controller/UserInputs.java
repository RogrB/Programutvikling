...
public class UserInputs {
    ...
    public void setKeyListeners(Scene s){
        s.setOnKeyPressed(event -> {
            ...
            if (event.getCode() == KeyCode.SPACE  && !GameController.gs.player.getPlaying() && !GameController.gs.player.isAlive()|| event.getCode() == KeyCode.ENTER && !GameController.gs.player.getPlaying() && !GameController.gs.player.getPlaying())
